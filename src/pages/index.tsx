  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your career journey with CV Application - Your ultimate tool for crafting compelling and professional resumes."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1641368255943-674052d0f003?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxDVnxlbnwwfHx8fDE2OTA5MTk3NTd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@leoneciao?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Leone Morandini`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your career journey with CV Application - Your ultimate tool for crafting compelling and professional resumes.`}
            </Text>
            <Box
